...
class avr_t(_object):
    ...
    if _newclass:address_size = _swig_property(_simavr.avr_t_address_size_get, _simavr.avr_t_address_size_set)
    ...
    if _newclass:run_cycle_count = _swig_property(_simavr.avr_t_run_cycle_count_get, _simavr.avr_t_run_cycle_count_set)
    ...
    if _newclass:run_cycle_limit = _swig_property(_simavr.avr_t_run_cycle_limit_get, _simavr.avr_t_run_cycle_limit_set)
    ...
    if _newclass:interrupt_state = _swig_property(_simavr.avr_t_interrupt_state_get, _simavr.avr_t_interrupt_state_set)
    ...
    if _newclass:reset_pc = _swig_property(_simavr.avr_t_reset_pc_get, _simavr.avr_t_reset_pc_set)
    ...
    if _newclass:custom = _swig_property(_simavr.avr_t_custom_get)
...
class avr_t_custom(_object):
    ...
    if _newclass:init = _swig_property(_simavr.avr_t_custom_init_get, _simavr.avr_t_custom_init_set)
    __swig_setmethods__["deinit"] = _simavr.avr_t_custom_deinit_set
    __swig_getmethods__["deinit"] = _simavr.avr_t_custom_deinit_get
    if _newclass:deinit = _swig_property(_simavr.avr_t_custom_deinit_get, _simavr.avr_t_custom_deinit_set)
    __swig_setmethods__["data"] = _simavr.avr_t_custom_data_set
    __swig_getmethods__["data"] = _simavr.avr_t_custom_data_get
    if _newclass:data = _swig_property(_simavr.avr_t_custom_data_get, _simavr.avr_t_custom_data_set)
    def __init__(self): 
...
class avr_symbol_t(_object):
    ...
    if _newclass:symbol = _swig_property(_simavr.avr_symbol_t_symbol_get)
    def __init__(self): 
...
def avr_global_logger(*args):
  return _simavr.avr_global_logger(*args)
avr_global_logger = _simavr.avr_global_logger

def avr_global_logger_set(*args):
  return _simavr.avr_global_logger_set(*args)
...
def avr_pending_sleep_usec(*args):
  return _simavr.avr_pending_sleep_usec(*args)
...
class avr_ioport_external_t(_object):
    ...
    if _newclass:name = _swig_property(_simavr.avr_ioport_external_t_name_get, _simavr.avr_ioport_external_t_name_set)
    ...
    if _newclass:mask = _swig_property(_simavr.avr_ioport_external_t_mask_get, _simavr.avr_ioport_external_t_mask_set)
    ...
    if _newclass:value = _swig_property(_simavr.avr_ioport_external_t_value_get, _simavr.avr_ioport_external_t_value_set)
    def __init__(self): 
...
class avr_ioport_t(_object):
    ...
    if _newclass:external = _swig_property(_simavr.avr_ioport_t_external_get)
    def __init__(self): 
...
class avr_ioport_t_external(_object):
    ...
    if _newclass:pull_mask = _swig_property(_simavr.avr_ioport_t_external_pull_mask_get, _simavr.avr_ioport_t_external_pull_mask_set)
    ...
    if _newclass:pull_value = _swig_property(_simavr.avr_ioport_t_external_pull_value_get, _simavr.avr_ioport_t_external_pull_value_set)
    def __init__(self): 
...
class elf_firmware_t(_object):
    ...
    if _newclass:symbol = _swig_property(_simavr.elf_firmware_t_symbol_get, _simavr.elf_firmware_t_symbol_set)
    ...
    if _newclass:symbolcount = _swig_property(_simavr.elf_firmware_t_symbolcount_get, _simavr.elf_firmware_t_symbolcount_set)
    ...
    if _newclass:external_state = _swig_property(_simavr.elf_firmware_t_external_state_get)
    def __init__(self): 
...
class elf_firmware_t_external_state(_object):
    ...
    if _newclass:port = _swig_property(_simavr.elf_firmware_t_external_state_port_get, _simavr.elf_firmware_t_external_state_port_set)
    ...
    if _newclass:mask = _swig_property(_simavr.elf_firmware_t_external_state_mask_get, _simavr.elf_firmware_t_external_state_mask_set)
    ...
    if _newclass:value = _swig_property(_simavr.elf_firmware_t_external_state_value_get, _simavr.elf_firmware_t_external_state_value_set)
    def __init__(self): 
